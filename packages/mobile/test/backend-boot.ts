...
import { loadSettings } from "../../backend/src/config";
...
async function boot() {
  ...
  if (allContacts.length >= 4) {
    await db
      ...
      .set({
        notes: "Works at Acme Corp as a product manager",
        avatarUrl:
          "https://ui-avatars.com/api/?name=Contact+1&background=4F46E5&color=fff",
      })
    ...
    await db
      ...
      .set({
        ...
        avatarUrl:
          "https://ui-avatars.com/api/?name=Contact+2&background=10B981&color=fff",
      })
    ...
    await db
      ...
      .set({
        avatarUrl:
          "https://ui-avatars.com/api/?name=Contact+3&background=F59E0B&color=fff",
      })
    ...
    await db
      ...
      .set({
        avatarUrl:
          "https://ui-avatars.com/api/?name=Contact+4&background=EF4444&color=fff",
      })
